...
public class Demo {
    public static void main(String[] Args){
        ...
        System.out.println("Initial Settings : " + context);
        ...
        System.out.println("Speed Chain Pulled; Next Speed State : " + context);
        ...
        System.out.println("Direction Chain Pulled; Next Direction State : " + context);
